...
public class BaseDatos extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db){
		String createTablaMascotas = " CREATE TABLE " + ConstantesBaseDatos.TABLE_MASCOTA + "(" +
			ConstantesBaseDatos.TABLE_MASCOTA_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
			ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE + " TEXT, " +
			ConstantesBaseDatos.TABLE_MASCOTA_FOTO + " INTEGER" + ")";
		
		String createTablaLikes = " CREATE TABLE " + ConstantesBaseDatos.TABLE_LIKES_MASCOTA + "(" +
				ConstantesBaseDatos.TABLE_MASCOTA_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
				...
				"REFERENCES " + ConstantesBaseDatos.TABLE_MASCOTA + "(" + ConstantesBaseDatos.TABLE_LIKES_MASCOTA_ID + ")" +
				")";
		
		db.execSQL (createTablaMascotas);
		db.execSQL (createTablaLikes);
	}
	...
	public ArrayList<Mascotas>obtenerTodasLasMascota(){
		...
		while(registros.moveToNext ()){
			...
			String queryLikes = " SELECT COUNT(" +
					ConstantesBaseDatos.TABLE_LIKES_MASCOTA_NUMERO_LIKES + ") as likes" +
